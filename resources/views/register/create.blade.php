            ...
            <div class="p-6 sm:p-8 bg-white shadow-sm border border-emerald-100 sm:rounded-2xl max-w-2xl">
                ...
                <form method="POST" action="{{ route('register.store') }}" class="space-y-6">
                    ...
                    <div class="flex items-center gap-4 pt-4">
                        <button type="submit" class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-md hover:shadow-emerald-600/20 transition duration-150 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 text-sm tracking-wide">
                            💾 Simpan Transaksi
                        </button>

                        <a href="{{ route('register.index') }}" class="px-5 py-2.5 border border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition duration-150 text-sm">
                            Batal
                        </a>
                    </div>
                </form>
